...
def prepare_clinical_data_for_ingest(ingest_json):
    ...
    for program_id in by_program.keys():
        ...
        if len(schema.validation_errors) > 0:
            ...
            print(f"Has Error: Validating  {program_id}")
            print("--------------------------")
            print(errors)
            print("--------------------------")
            ...
            print(f"NO error Validating {program_id}")
...
def main():
    ...
    if "openapi_url" not in ingest_json:
        ...
        # Note: need to use 'raw' from https://raw.githubusercontent.com/rjiang9/candigingestschema/main/schema.yml
        # NOT work: "https://github.com/rjiang9/candigingestschema/blob/main/schema.yml"
        ingest_json["openapi_url"] = "https://raw.githubusercontent.com/rjiang9/candigingestschema/main/schema.yml"
